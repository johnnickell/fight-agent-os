...
**Status: private, planning-ready scaffold.** The application currently contains an inherited Slim/PHP foundation.
...
The inherited starter retains its [MIT license](LICENSE). This repository is private.
