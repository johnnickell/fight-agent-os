...
return static function (DeptracConfig $config): void {
    ...
    $defaultPaths = [__DIR__.'/src', __DIR__.'/config', __DIR__.'/bootstrap', __DIR__.'/public', __DIR__.'/scripts'];
    $paths = $configuredPaths === false || $configuredPaths === '' ? $defaultPaths : array_map(
    ...
    $config
        ...
        ->layers(
            ...
            $composition = Layer::withName('Composition')->collectors(
                DirectoryConfig::create('(^|/)(?:config|bootstrap|public|scripts)/')
            ),
        ...
        ->rulesets(
            ...
            Ruleset::forLayer($composition)->accesses(
                $domain,
                $application,
                $adapter,
                $accessControlDomain,
