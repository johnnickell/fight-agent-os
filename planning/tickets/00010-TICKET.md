...
| ID | Title | Status |
|---|---|---|
| [TASK-00017](../tasks/00017-TASK.md) | Accept the browser-authentication security-profile ADR | ready-for-agent |
| [TASK-00018](../tasks/00018-TASK.md) | Establish the versioned JSend API interaction boundary | ready-for-agent |
