...
[Research MCP Skills and Pi support (WF-013)](tickets/WF-013-research-mcp-skills-and-pi-support.md) is the one recommended next decision. Repository context and the authoritative Planning model are now settled, while factual MCP/Pi capability research can proceed independently and unlock the skill/harness decision before coordinated work depends on an unsupported transport. WF-011 and WF-012 are also dependency-eligible but remain separate migration and browser-product decisions.
